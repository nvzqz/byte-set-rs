...
//! types for a variety of scenarios. See ["Implementation"](#implementation)
...
//! ### `rand`
//!
//! Use the `rand` (or `rand_core`) feature in your [`Cargo.toml`] to enable
//! random [`ByteSet`] generation:
//!
//! ```toml
